...
public class Adb4pgClientProxy implements AdbProxy {
    private static final Logger logger = LoggerFactory.getLogger(Adb4pgClientProxy.class);
    ...
    public Adb4pgClientProxy(Configuration configuration,TaskPluginCollector  taskPluginCollector) {
        ...
        databaseConfig.setLogger(Adb4pgClientProxy.logger);
    ...
    public void closeResource() {
        try {
            logger.info("stop the adb4pgClient");
