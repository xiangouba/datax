...
public class ReaderRunner extends AbstractRunner implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            logger.debug("task reader starts to do post ...");
            ...
            logger.error("Reader runner Received Exceptions:", e);
            super.markFail(e);
        } finally {
            logger.debug("task reader starts to do destroy ...");
