...
public class Engine {
    ...
    public void start(Configuration allConf) {
        ...
        try {
            ...
            logger.warn("prioriy set to 0, because NumberFormatException, the value is: " + System.getProperty("PROIORY"));
        }
...
//            Engine.entry(dataArgs);
    ...
    //
    //    //System.setProperty("datax.home", "D:\\LPH\\MyObject\\datax\\DataX-master\\target\\datax\\datax");  //datax编译后的目录
    //    System.setProperty("datax.home", "D:\\SoftWare\\datax\\datax");  //datax编译后的目录
    //    String[] datxArgs = {"-job", "D:\\LPH\\Document\\英大\\datax-web\\test.json", "-mode", "standalone", "-jobid", "-1"};  //自己的json文件路径
    //
    //    int exitCode = 0;
    //    try {
    //
