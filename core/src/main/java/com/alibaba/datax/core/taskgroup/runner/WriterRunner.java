...
public class WriterRunner extends AbstractRunner implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            logger.error("Writer Runner Received Exceptions:", e);
            super.markFail(e);
        } finally {
            logger.debug("task writer starts to do destroy ...");
