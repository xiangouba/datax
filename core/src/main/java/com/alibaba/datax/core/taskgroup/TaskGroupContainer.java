    ...
    public void start() {
        try {
            ...
            if(logger.isDebugEnabled()) {
                logger.debug("taskGroup[{}]'s task configs[{}]", this.taskGroupId,
            ...
            while (true) {
            	...
            	for(Map.Entry<Integer, Communication> entry : communicationMap.entrySet()){
            		...
            		if(taskCommunication.getState() == State.FAILED){
                        ...
                        if(taskStartTime != null){
                            ...
                            logger.info("taskGroup[{}] taskId[{}] is successed, used[{}]ms",
                ...
                while(iterator.hasNext() && runTasks.size() < channelNumber){
                    ...
                    if(lastExecutor!=null){
                        ...
                        if(!lastExecutor.isShutdown()){ //上次失败的task仍未结束
                            ...
                            logger.info("taskGroup[{}] taskId[{}] attemptCount[{}] has already shutdown",
                    ...
                    logger.info("taskGroup[{}] taskId[{}] attemptCount[{}] is started",
                ...
                if (taskQueue.isEmpty() && isAllTaskDone(runTasks) && containerCommunicator.collectState() == State.SUCCEEDED) {
                    ...
                    logger.info("taskGroup[{}] completed it's tasks.", this.taskGroupId);
                    break;
                }
        ...
        private AbstractRunner generateRunner(PluginType pluginType, List<TransformerExecution> transformerInfoExecs) {
            ...
            switch (pluginType) {
                ...
                case WRITER:
                    ...
                    ((WriterRunner) newRunner).setRecordSender(recordSender);
