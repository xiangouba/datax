    ...
    public static class Job extends Reader.Job {
        ...
        public void init() {
            ...
            try {
                ...
                logger.error("OTSException. ErrorCode:{}, ErrorMsg:{}, RequestId:{}", 
                ...
                logger.error("ClientException. ErrorCode:{}, ErrorMsg:{}", 
