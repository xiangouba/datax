	...
	public static class Job {
		...
		private void checkConf(Configuration originalConfig) {
			...
			try (HoloClient client = new HoloClient(config)) {
				...
				logger.info("table {} column info:", schema.getTableNameObj().getFullName());
				for (com.alibaba.hologres.client.model.Column column : schema.getColumnSchema()) {
					logger.info("name:{},type:{},typeName:{},nullable:{},defaultValue:{}", column.getName(), column.getType(), column.getTypeName(), column.getAllowNull(), column.getDefaultValue());
				}
