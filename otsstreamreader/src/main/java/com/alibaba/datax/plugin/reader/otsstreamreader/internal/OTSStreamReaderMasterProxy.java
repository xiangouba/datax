...
public class OTSStreamReaderMasterProxy {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OTSStreamReaderConfig.class);
    ...
    public void init(OTSStreamReaderConfig config) throws Exception {
        ...
        logger.info("Start stream job: {}.", streamJob.toJson());
    }
    ...
    public List<Configuration> split(int adviceNumber) {
        ...
        logger.info("Master split to {} slave, with advice number {}.", configurations.size(), adviceNumber);
