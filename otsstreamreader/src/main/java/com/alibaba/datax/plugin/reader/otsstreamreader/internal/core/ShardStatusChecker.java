...
public class ShardStatusChecker {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ShardStatusChecker.class);
            ...
            if (allShardToProcess.containsKey(shardId)) {
                ...
                switch (entry.getValue()) {
                    ...
                    case SKIP:
                        ...
                        break;
                    default:
                        logger.error("Unexpected state '{}' for shard '{}'.", entry.getValue(), shard);
    ...
    public static ProcessState determineShardState(
        ...
        if (shard == null) {
            ...
            logger.warn("Shard is not found: {}.", shardId);
