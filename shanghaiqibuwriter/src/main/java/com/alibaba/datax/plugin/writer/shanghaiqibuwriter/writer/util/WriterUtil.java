...
import com.alibaba.datax.plugin.writer.shanghaiqibuwriter.writer.Constant;
...
public final class WriterUtil {
    ...
    public static String getDeleteTemplate(){
        ...
        //判断是否为MySQL数据库
        deleteDataSqlTemplate = new StringBuilder()
                    .append("DELETE FROM %s WHERE %s in ('")
                    .toString();
        return deleteDataSqlTemplate;
    }
    ...
    public static void preCheckPrePareSQL(Configuration originalConfig, DataBaseType type) {
        ...
        if (null != renderedPreSqls && !renderedPreSqls.isEmpty()) {
            logger.info("Begin to preCheck preSqls:[{}].", StringUtils.join(renderedPreSqls, ";"));
    ...
    public static void preCheckPostSQL(Configuration originalConfig, DataBaseType type) {
        ...
        if (null != renderedPostSqls && !renderedPostSqls.isEmpty()) {
            ...
            logger.info("Begin to preCheck postSqls:[{}].",
