...
public abstract class HbaseAbstractTask {
    private final static Logger logger = LoggerFactory.getLogger(HbaseAbstractTask.class);
    ...
    public void prepare() throws Exception {
        ...
        logger.info("The task set startRowkey=[{}], endRowkey=[{}].", Bytes.toStringBinary(this.startKey), Bytes.toStringBinary(this.endKey));
