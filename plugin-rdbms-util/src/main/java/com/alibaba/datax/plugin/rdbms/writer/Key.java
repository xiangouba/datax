...
public final class Key {
    ...
    public final static String USERNAME_MYSQL = "usernameMysql";
    public final static String USERNAME_ORACLE = "usernameOracle";

    public final static String PASSWORD = "password";

    public final static String PASSWORD_MYSQL = "passwordMysql";
    public final static String PASSWORD_ORACLE = "passwordOracle";
